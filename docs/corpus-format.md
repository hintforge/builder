...
A directory is a Hintforge corpus if and only if it contains the four universal published directories and ten universal files listed below. The reader can assume every corpus has these and route to them by name.
